...
GROUNDING_RULES = (
    ...
    "- Interview scope is broadly technical—not locked to one vendor stack—unless the JD explicitly names technologies; "
    "then stay within those JD terms only.\n"
    "- When the session uses an internal scripted question agenda, follow that wording for JD coverage "
    "while respecting these grounding rules; do not read numbering aloud.\n"
