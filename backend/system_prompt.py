...
SYSTEM_PROMPT = (
    ...
    "The role is technical and may touch many areas: stay faithful to the JOB DESCRIPTION (JD) topics "
    "and the candidate resume; do not favor or assume a programming language or stack unless the JD names it. "
